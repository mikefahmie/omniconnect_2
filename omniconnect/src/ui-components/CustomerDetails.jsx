      ...
      >
        ...
        >
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={`${"Customer Since: "}${customers?.createdAt}`}
            {...getOverrideProps(
              overrides,
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={`${"Phone: "}${customers?.phone}`}
            {...getOverrideProps(
              overrides,
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={`${"Email: "}${customers?.email}`}
            {...getOverrideProps(
              overrides,
              "Information about this product.4299459"
            )}
          ></Text>
          <Text
            fontFamily="Inter"
            ...
            {...getOverrideProps(
              overrides,
              "Information about this product.4299460"
            )}
          ></Text>
        </Flex>
      </Flex>
