    ...
    >
      ...
      >
        ...
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="OmniConnect CRM"
          {...getOverrideProps(overrides, "OmniConnect CRM")}
        ></Text>
      </Flex>
      <Flex
        gap="40px"
      ...
      >
        <Text
          ...
          {...getOverrideProps(overrides, "Add Customer")}
        ></Text>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          {...getOverrideProps(overrides, "Add New Order")}
        ></Text>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          {...getOverrideProps(overrides, "Show Customers")}
        ></Text>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          {...getOverrideProps(overrides, "Show Orders")}
        ></Text>
      </Flex>
    </Flex>
  );
